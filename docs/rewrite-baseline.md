...
> ⚠️ **历史资料**：二维云台/瞄准子系统（gimbal / auto_aim / aim_solver / aim_fusion /
> localization / bldc / step_motor）与原任务框架 app 已整体移除，新任务待定。本文件中涉及
> 云台绝对角、靶心几何前馈、视觉 bias、定位航位推算、E 题任务状态机的章节已**不再对应现有
> 代码**，仅作旧任务的行为/标定归档；底盘、巡线、TB6612、灰度、IMU 等仍在用的常量仍具参考
> 价值。新任务确定后按需重建本基准。
>
> ---
>
